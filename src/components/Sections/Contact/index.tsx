    ...
    <Section className="bg-black-800" sectionId={SectionId.Contact}>
      <div className="flex flex-col gap-y-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-center">
          <EnvelopeIcon className="hidden w-16 h-16 text-white md:block" />
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="flex flex-col order-1 col-span-1 gap-y-4 md:order-2">
            <p className="leading-6 prose text-neutral-300">{description}</p>
                  ...
                  <div key={srLabel}>
                    ...
                    <dd className="flex items-center">
                      <a
                        ...
                        <Icon
                          aria-hidden="true"
                          className="flex-shrink-0 w-4 h-4 text-neutral-100 sm:h-5 sm:w-5"
                          id="social-links"
                        />
